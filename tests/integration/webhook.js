  ...
  describe("#isValid", function() {
    it("should return true for a webhook with correct signature", function() {
      var webhook = new WebHook(token, {
        headers: {
          "x-eventflit-key": "123456789",
          "x-eventflit-signature": "df1465f5ff93f83238152fd002cb904f9562d39569e68f00a6bfa0d8ccf88334",
  ...
  describe("#getData", function() {
    ...
    it("should throw an error if content type is not `application/json`", function() {
      ...
      expect(function() {
        ...
        expect(e).to.be.a(Eventflit.WebHookError);
